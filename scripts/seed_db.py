"""
Seed starter community groups into the database.
Run once after first deploy from Render Shell or locally.
...
from backend.app.models.social import CommunityGroup
